 ...
 * id allows data from multiple devices to be recorded to a single file.
 */
- (void)addConfiguration:(int32_t)id macAddress:(NSString *)macAddress configuration:(IXNMuseConfiguration *)configuration;
 ...
 */
- (void)addDsp:(int32_t)id type:(NSString *)type floatArray:(NSArray *)floatArray intArray:(NSArray *)intArray version:(NSString *)version;
